...
| [skill-publishing](./plugins/skill-publishing/) | 4.3.0 | 1 | 0 | Plugin-first publishing for Claude Code skills. Auto-assembles and syncs plugins from plugin-manifest.json files. Also supports bare skills and individual repos |
...
| [spec-review](./plugins/spec-review/) | 2.2.2 | 1 | 0 | Reviews and enriches story specifications with codebase-verified sub-tasks, architecture alignment, design simplification, and API test plans. |
