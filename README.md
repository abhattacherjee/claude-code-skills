...
|--------|---------|--------|----------|-------------|
| [figma-ui-designer](./plugins/figma-ui-designer/) | 3.0.0 | 1 | 0 | Interactive Figma UI design skill with brainstorming, progress tracking, and design-to-code bridging via Figma MCP |
